            ...
            <div class="row">
                 <div class="col-sm-5 well">
                     <label ><b><u>Search Organizations</u><b></label>
                                 <br/>
                <form method="post"  action="${pageContext.request.contextPath}/admin/organization/search"class="form-signin-heading" >
                 ...
                 <div class="col-sm-5 well col-sm-offset-2">
                     <label ><b><u>Add/Edit Organizations</u><b></label>
                                 <br/>
                  <form commandName="organization"  action="${pageContext.request.contextPath}/admin/organization/build" method="POST" class="form-signin-heading" >
                    <input type="text" class="form-control" placeholder="Name" name="name" value="${organization.name}" required="true"/>
                        <br/>
                        <input  type="text" class="form-control" placeholder="Type" name="type" value="${organization.type}" required="true"/>
                        <br/>
                        <input  type="text" class="form-control" placeholder="Url" name="url" value="${organization.url}" required="true"/>
                        <br/>
